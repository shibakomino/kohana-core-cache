...
class Fragment
{
    ...
    protected static function _cache_key($name, $i18n = null)
    {
        ...
        $i18n = ($i18n === true) ? setlocale(LC_ALL, 0) : '';
    ...
    public static function load($name, $lifetime = null, $i18n = null)
    {
        ...
        if ($fragment = Cache::cache($cache_key, null, $lifetime)) {
    ...
    public static function save()
    {
        ...
        if (isset(static::$_caches[$level])) {
            ...
            // Cache the fragment
            Cache::cache($cache_key, $fragment);
        }
    }
    ...
    {
        // Invalid the cache
        Cache::cache(static::_cache_key($name, $i18n), null, -3600);
    }
